 ...
 * `providers/keyvalue/redis.ts:1911`, both gated on `spec.acceptsSourceEdits === true`, which is the
 ...
 * stated at `redis.ts:1904-1910`: the affordance is offered on a truncated part deliberately, because
 ...
 * than it inside `buildObjectEdit`: `providers/sql/postgres.ts:3366`, `providers/keyvalue/redis.ts:2001`
